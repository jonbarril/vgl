...
public class StatusFileSummaryTest {
    ...
    public void fileSummaryUsesAddedModifiedRenamedDeletedOrder() throws Exception {
        ...
        try {
            ...
            StatusFileSummary.printFileSummary(2, 5, 3, 1, 0,
                Collections.<String>emptySet(), Collections.<String>emptySet(), Collections.<String>emptySet(), Collections.<String>emptySet(), 8);
