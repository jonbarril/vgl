...
public class HelpCommand implements Command {
    ...
    @Override public int run(List<String> args) {
        ...
        helpText.append(String.join("\n",
            ...
            "",
            "Commands:",
            "  create [DIR] [-b BRANCH]              Create local repo+branch, set as current workspace",
            ...
            "  checkin -draft|-final                 Push and create pull request (PR)",
        ...
        if (args.contains("-vv")) {
            ...
            helpText.append(String.join("\n",
                "  Working Locally:",
                "    Use 'create' to make a new local repository in a directory (or",
                "    'local' to switch to existing ones). Your workspace is where your working",
                "    files live. Changes you make exist only in the workspace until you 'commit'",
                "    them to the local repository's branch (default: main). This records a",
                "    snapshot you can return to later. You can work entirely locally without any",
                "    remote setup.",
                "",
                "  Adding Remote Collaboration (Optional):",
                "    Use 'remote' to configure a remote repository for cloud backup and team",
