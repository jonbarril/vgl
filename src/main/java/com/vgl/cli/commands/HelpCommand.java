...
public class HelpCommand implements Command {
    ...
    @Override public int run(List<String> args) {
        ...
        helpText.append(String.join("\n",
            ...
            "",
            "Commands:",
            "  create [-lr DIR][-lb BRANCH][-bb BRANCH]       Creates a new empty local repo and/or branch, and",
            "                                                 switches to them",
            "  create [-rr URL][-rb BRANCH]                   (TBD) Creates a new empty remote repo and/or branch,",
            "                                                 and switches to them",
            "  checkout [-rr URL] [-rb BRANCH]                Clones a remote repo branch, replacing the",
            "                                                 the local branch and working files (shortcut)",
            "  switch [-lr DIR][-rr URL] [[-lb BRANCH][-rb BRANCH]]|[-bb BRANCH]]",
            "                                                 Switch to different repos and branches (shortcut)",
            "  jump                                           Toggles to previous switch state",
            "  delete [-lr][-rr] [[-lb][-rb]]|[-bb]]          Deletes switch state repos and branches",
