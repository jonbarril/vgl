...
public class HelpCommand implements Command {
    ...
    @Override public int run(List<String> args) {
        ...
        helpText.append(String.join("\n",
            ...
            "Commands:",
            "  create [-f]",
            "    [-lr DIR] [-lb BRANCH]              Create local repository and/or",
            "                                          branch and switch to it",
            "    [-bb BRANCH]                        Create branch locally and remotely",
            "                                          and switch to it",
            "    [-rr URL] [-rb BRANCH]              (TBD) Create remote repository",
            "                                          and/or branch — use hosting tools",
            "  delete [-f]",
            ...
            "    [-rr [URL]] [-rb [BRANCH]]          (TBD) Delete remote repository",
            "                                          and/or branch — use hosting tools",
            "  checkout [-f]",
            "    [-rr [URL]] [-rb [BRANCH]]          Clone remote into local repository",
            "                                          (default: switch state) — Shortcut",
            "  switch [-f]                           Switch repositories and branches,",
            "                                          local and/or remote",
            "    [-lr DIR] [-lb BRANCH]              (local)",
            "    [-bb BRANCH]                        (both)",
            "    [-rr URL] [-rb BRANCH]              (remote)",
            "  jump                                  Toggles to previous switch state",
            "  split -into|-from                     Clone branch from source (switch",
            "                                          state or specified) — Shortcut",
            "    [-lr [DIR]] [-lb [BRANCH]]          Local source or target",
            "                                          (default: switch state)",
            "    [-rr [URL]] [-rb [BRANCH]]          Remote source or target",
            "                                          (default: switch state)",
            "    [-bb [BRANCH]]                      Both local and remote with same name",
            "                                          (default: switch state)",
            "  merge -into|-from                     Merge branch into target (switch",
            "                                          state or specified) — Shortcut",
            "    [-lr [DIR]] [-lb [BRANCH]]          Local source or target",
            "                                          (default: switch state)",
            "    [-rr [URL]] [-rb [BRANCH]]          Remote source or target",
            ...
            "  restore [-f] -lb|-rb [COMMIT|GLOB|*]           Revert working files to local or remote versions",
