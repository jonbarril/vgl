...
- **Review on refactor:** Every time code is refactored (behavioral, architectural, or API changes), the author must review `docs/VGL-UseCases.md` and update it as necessary.
...
- **Living doc:** Treat `docs/VGL-UseCases.md` as the authoritative living specification for CLI behaviors; tests and implementation should aim to satisfy the documented use cases.
